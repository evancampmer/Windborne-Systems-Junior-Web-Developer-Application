...
@st.cache_data
def load_shapefiles():
    countries = gpd.read_file(r"C:\Users\ecamp\windborne-flight-ingestion\shapefiles\ne_10m_admin_0_countries.shp")
    states = gpd.read_file(r"C:\Users\ecamp\windborne-flight-ingestion\shapefiles\ne_10m_admin_1_states_provinces.shp")
